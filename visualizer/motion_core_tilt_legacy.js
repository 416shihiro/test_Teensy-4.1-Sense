/**
 * FROZEN BACKUP — tilt (accel gravity) motion pipeline before 2026-06 direct mode.
 * To revert: set motion mode to "tilt" in viz UI, or copy logic from this file.
 * Do not import in production; reference / diff only.
 */
